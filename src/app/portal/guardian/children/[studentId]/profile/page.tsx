...
export default async function GuardianChildProfilePage({
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-5 pb-10">
      ...
      {/* ------------------------------------------------------------------- */}
      {/* Quick Portal Navigation Links for Guardian                          */}
      {/* ------------------------------------------------------------------- */}
      <section className="rounded-xl border border-border bg-card p-5 shadow-2xs">
        <div className="flex items-center justify-between border-b border-border pb-3">
          <h2 className="text-sm font-bold text-brand-navy">Child Portal Shortcuts</h2>
          <span className="text-xs text-muted-foreground">Quick access</span>
        </div>

        <div className="mt-3.5 grid grid-cols-2 gap-2.5 sm:grid-cols-4">
          <Link
            href={`/portal/guardian/children/${student.id}/attendance`}
          ...
          <Link
            href={`/portal/guardian/children/${student.id}/results`}
            className="group flex flex-col justify-between rounded-xl border border-border/70 bg-[#fafaf8] p-3.5 transition-all hover:-translate-y-0.5 hover:border-border hover:bg-card hover:shadow-xs"
          >
          ...
          <Link
            href={`/portal/guardian/children/${student.id}/homework`}
            className="group flex flex-col justify-between rounded-xl border border-border/70 bg-[#fafaf8] p-3.5 transition-all hover:-translate-y-0.5 hover:border-border hover:bg-card hover:shadow-xs"
          >
          ...
          <Link
            href={`/portal/guardian/children/${student.id}/fees`}
            className="group flex flex-col justify-between rounded-xl border border-border/70 bg-[#fafaf8] p-3.5 transition-all hover:-translate-y-0.5 hover:border-border hover:bg-card hover:shadow-xs"
          >
