...
import { CalendarRange, Layers, BookOpen, Users2, Clock } from "lucide-react"
...
export default async function AcademicsPage() {
  ...
  const entries: DirectoryEntry[] = [
    ...
    { href: "/academics/routine", icon: Clock, title: t("routine.title"), description: t("routine.description") },
  ]
